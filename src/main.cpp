...
int64 nChainStartTime = 1452646243;
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	if(nHeight == 1)
	{
		nSubsidy = 68980000 * COIN;	// 1 billion coins, that all pow coins
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Jan 13, 2016, BaiJinCoin start   Putin Signs Treaty To Add Crimea To Map.";
        CTransaction txNew;
        ...
        printf("block.nNonce = %u \n", block.nNonce);
			block.print();
        assert(block.hashMerkleRoot == uint256("0x58eca0947077b8375a85192b42a74002e940d7607e5bb90ae2c0e4f94e54f776"));
